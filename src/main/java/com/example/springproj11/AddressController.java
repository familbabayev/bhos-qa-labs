...
public class AddressController {
    ...
    public ResponseEntity<Address> updateAddressByID(@RequestParam UUID id,
    ...
    public ResponseEntity<Address> updateAddressByName(@RequestParam String name,
                                                       @RequestParam String address_line) {
        try {
    ...
    public ResponseEntity<Address> createAddress(@RequestParam String name, @RequestParam String address_line,
